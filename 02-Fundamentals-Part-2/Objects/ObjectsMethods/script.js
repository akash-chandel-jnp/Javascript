...
//NOTE: just like array which can store any type of value, Objects can also store any type for value corresponding to its properties.
//NOTE: it can store any value, like string , number, array, other objects, or even a function as function can be be written as an expression.
...
const praveen = {
	...
	}, // birthyear will need to be passed while calling the object
...
const anjali = {
	...
	findAgee: function () {
		...
		} // this is similar code we use for adding any property in an object --> so now anjali object has one more property listed as age ..
	...
	getSummary: function () {
		return `${
			this.firstName
		} is a ${this.findAgee()} years old person , who lives in ${
			this.city
		} and she ${
			this.hasDriverLicense ? "has a" : "does not have any "
		} driverLicense. `;
	},
};
